...
<body>
<form href="http://localhost:8080/online-book-store-application/SerachBookServlet"  method="POST">
<div>
<ul class="topnav">
...
<div class="letter"><h1>WELCOME TO SEARCH A BOOK</h1> </div>
 <center><input type="text" id="search" name="search" placeholder="Enter a valid ISBN"><input type="submit"  value="Search"></center>
<center>
<br>
<br>
<table border="4">
